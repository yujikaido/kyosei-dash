 ...
 */
console.log("Welcome to Kyosei Dash 共生");
...
log.info("server", "Kyosei Dash Version:", checkVersion.version);
...
const { kumaBackupImportSocketHandler } = require("./socket-handlers/kuma-backup-import-socket-handler");
...
(async () => {
    ...
    io.on("connection", async (socket) => {
        ...
        kumaBackupImportSocketHandler(socket);
